...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 22, 2025 at 05:00 AM
...
--
-- Table structure for table `dog_bite_cases`
--

DROP TABLE IF EXISTS `dog_bite_cases`;
CREATE TABLE IF NOT EXISTS `dog_bite_cases` (
...
(28, 'Yuki', 'Aspin', 'Robbie Brian C Cagumbay', 'Yes', 13, NULL, NULL, '2025-03-28'),
...
(27, 'Chuckie', 'Shi Tzu', 'Elvin M Perater', 'Yes', 16, NULL, NULL, '2025-03-28');
